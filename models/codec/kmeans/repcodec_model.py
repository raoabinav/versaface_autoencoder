...
class RepCodec(nn.Module):
    def __init__(
        ...
        codebook_dim=8, # compression dimension 
        vocos_dim=384,
        ...
        # vocos backbone is vocoder based but just does linear here
    


        # [B,T,1024] -> [B, 1024, T] -> [B,T,384] -> [B,1024,T] -> [B,T,1024]
        ...
        # [B, T, 1024] -> [B, 1024, T] -> [B, 8, T] ->(codebook lookups) [B, T], -> (project back to 104), [B, 1024, T]

...
class ResidualVQ(nn.Module):
    ...
    def __init__(
        self,
        input_dim: int = 256,
        num_quantizers: int = 8, #default, but then initilized as 1
        codebook_size: int = 1024,
        codebook_dim: int = 256,
        quantizer_type: str = "vq",  # "vq" or "fvq" or "lfq", for this case we just a FVQ
        ...
        **kwargs,
        ...
        if quantizer_type == "vq": # without projection
            VQ = VectorQuantize
        elif quantizer_type == "fvq": # with projection to 8-D
    ...
    def forward(self, z, n_quantizers: int = None):
        ...
        for i, quantizer in enumerate(self.quantizers): # called once. 
            ...
            # [B, 1024, T]
            # commit_loss_i: [B] training loss
            # codebook_loss_i: [B] training loss
            # indices_i: [B, T]
            # z_e_i: [B, 8, T] PROJECTED LATENTS. NEED TO HOOK THIS. 
    ...
    # reverse of quanzitation, used for reconstruciton loss
